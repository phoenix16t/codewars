// http://www.codewars.com/kata/53fc954904a45eda6b00097f/train/javascript
...
Array.prototype.even = function(){
  return this.filter(function(elem) {
    return checkValid(elem) && (elem + 1) % 2;
  });
}

Array.prototype.odd = function(){
  return this.filter(function(elem) {
    return checkValid(elem) && elem % 2;
  });
}

Array.prototype.under = function(x){
  return this.filter(function(elem) {
    return checkValid(elem) && x - elem > 0;
  });
}
...
Array.prototype.inRange = function(min,max){
  ...
  return this.filter(function(elem) {
    return checkValid(elem) && elem >= min && elem <= max;
  });
}
